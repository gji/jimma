 ...
 * on 2015-04-11 at 22:18:55 UTC 
 * Modify at your own risk.
 */

package blue.jimma.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "addPost".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link AddPost#execute()} method to invoke the remote operation.
   *
   * @param content the {@link blue.jimma.backend.myApi.model.Post}
   * @return the request
   */
  public AddPost addPost(blue.jimma.backend.myApi.model.Post content) throws java.io.IOException {
    AddPost result = new AddPost(content);
    initialize(result);
    return result;
  }

  public class AddPost extends MyApiRequest<Void> {

    private static final String REST_PATH = "addPost";

    /**
     * Create a request for the method "addPost".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link AddPost#execute()} method to invoke the remote operation. <p>
     * {@link
     * AddPost#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)} must
     * be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param content the {@link blue.jimma.backend.myApi.model.Post}
     * @since 1.13
     */
    protected AddPost(blue.jimma.backend.myApi.model.Post content) {
      super(MyApi.this, "POST", REST_PATH, content, Void.class);
    }

    @Override
    public AddPost setAlt(java.lang.String alt) {
      return (AddPost) super.setAlt(alt);
    }

    @Override
    public AddPost setFields(java.lang.String fields) {
      return (AddPost) super.setFields(fields);
    }

    @Override
    public AddPost setKey(java.lang.String key) {
      return (AddPost) super.setKey(key);
    }

    @Override
    public AddPost setOauthToken(java.lang.String oauthToken) {
      return (AddPost) super.setOauthToken(oauthToken);
    }

    @Override
    public AddPost setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (AddPost) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public AddPost setQuotaUser(java.lang.String quotaUser) {
      return (AddPost) super.setQuotaUser(quotaUser);
    }

    @Override
    public AddPost setUserIp(java.lang.String userIp) {
      return (AddPost) super.setUserIp(userIp);
    }

    @Override
    public AddPost set(String parameterName, Object value) {
      return (AddPost) super.set(parameterName, value);
    }
  }
  ...
  public class GetPosts extends MyApiRequest<blue.jimma.backend.myApi.model.PostCollection> {
     ...
     */
    protected GetPosts() {
      super(MyApi.this, "GET", REST_PATH, null, blue.jimma.backend.myApi.model.PostCollection.class);
    }
   ...
   * @return the request
   */
  public GetUser getUser(java.lang.String name) throws java.io.IOException {
    GetUser result = new GetUser(name);
    initialize(result);
    return result;
  }

  public class GetUser extends MyApiRequest<blue.jimma.backend.myApi.model.User> {
     ...
     * @since 1.13
     */
    protected GetUser(java.lang.String name) {
      super(MyApi.this, "GET", REST_PATH, null, blue.jimma.backend.myApi.model.User.class);
  ...
  public class SayHi extends MyApiRequest<blue.jimma.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, blue.jimma.backend.myApi.model.MyBean.class);
      this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
    }
